...
class ExchangeActions(Generic[_PrismaModelT]):
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Exchange record ordered by the status field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Exchange record ordered by the createdAt field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Exchange records by status values
        # and count how many records are in each group
